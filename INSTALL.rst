...
* ``DB_NAME``: name of the database for the project. Defaults to ``boilerplate``.
* ``DB_USER``: username to connect to the database with. Defaults to ``boilerplate``.
* ``DB_PASSWORD``: password to use to connect to the database. Defaults to ``boilerplate``.
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting boilerplate_db_1 ... done
       Starting boilerplate_web_1 ... done
   ...
   .. code-block:: bash
       ...
       $ docker logs -f boilerplate_web_1
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it boilerplate_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it boilerplate_web_1 /app/src/manage.py loaddata admin_index groups
...
environment variables. See ``src/boilerplate/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker exec -it boilerplate /app/src/manage.py createsuperuser
