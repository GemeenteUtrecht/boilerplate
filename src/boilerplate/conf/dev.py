...
os.environ.setdefault("DB_NAME", "boilerplate"),
os.environ.setdefault("DB_USER", "boilerplate"),
os.environ.setdefault("DB_PASSWORD", "boilerplate"),
...
LOGGING["loggers"].update(
    {
        "boilerplate": {"handlers": ["console"], "level": "DEBUG", "propagate": True,},
