...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "boilerplate"),
        "USER": config("DB_USER", "boilerplate"),
        "PASSWORD": config("DB_PASSWORD", "boilerplate"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "boilerplate.utils.context_processors.settings",
...
AUTHENTICATION_BACKENDS = [
    ...
    "boilerplate.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
    "django_auth_adfs_db.backends.AdfsAuthCodeBackend",
]

SESSION_COOKIE_NAME = "boilerplate_sessionid"
